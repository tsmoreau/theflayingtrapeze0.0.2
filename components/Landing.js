        ...
        <div className="transform -translate-y-3 lg:translate-x-16">
          <div className="  flex flex-col justify-end">
            ...
            <div className=" flex inline-flex justify-center">
              <a
                className="ml-2 inline-flex items-center px-8 py-1 mt-4 font-normal bg-gradient-to-br from-amber-300 via-rose-600  to-blue-800 hover:amber-200 hover:via-violet-600 hover:to-sky-900 inline-flex items-center py-3 mt-4 font-normal text-white   active:bg-blue-600 rounded-md text-md md:mt-0"
                href="/market"
              >
